...
export const WORKSPACE_OVERVIEW_DOM = {
  ...
  inputs: {
    ip: `${bsWksOverview} input[formcontrolname="ip"]`,
    port: `${bsWksOverview} input[formcontrolname="port"]`,
    username: `${bsWksOverview} input[formcontrolname="username"]`,
    password: `${bsWksOverview} input[formcontrolname="password"]`,
    passphrase: `${bsWksOverview} input[formcontrolname="passphrase"]`,
