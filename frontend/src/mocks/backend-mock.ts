...
export const CORRECT_SETUP_USER = 'CORRECT_SETUP_USER';
...
export const errorActualBackendLongText = `org.ow2.petals.jmx.api.api.exception.ConnectionErrorException: java.net.UnknownHostException: IMPORT_HTTP_ERROR_IP_LONG_TEXT: Name or service not known`;
