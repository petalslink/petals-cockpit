...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: 'app/features-module/login-module/login-module.module#LoginModule'
  },
  {
    path: 'cockpit',
    canActivate: [AuthGuardService],
    loadChildren: 'app/features-module/cockpit-module/cockpit-module.module#CockpitModule'
  }
];
