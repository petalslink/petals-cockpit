...
import { ServicesEndpointOverviewComponent } from '@wks/services-content/services-endpoint-view/services-enpoint-overview/services-endpoint-overview.component';
